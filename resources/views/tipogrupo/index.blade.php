                    ...
                    <table class="table table-striped table-bordered dom-jQuery-events">
                      ...
                      @foreach($tipogrupos as $tipogrupo)
                            <tr>                                
                                ...
                                <td>                                       
                                  <button type="button" title="Editar Registro" class="btn icon-table" data-toggle="modal" data-target=".bd-example-modal-lg" onclick="MostrarTipoGrupo({{$tipogrupo->IdTipoGrupo}})"><i class="far far fa-edit"></i></button>
